...
export function PartnersPage() {
    ...
    return (
        <>
            <VikingBanner header="Partner love" subHeader="December 8th - 9th 2021"/>
            ...
            <Section color="blue" header={<h1>Partnership ticket</h1>}>
                <PartnerPriceList>
                    ...
                    <PartnerPrice item="Tickets for employees (Partner Late-Bird - After September 30th, 2021)">7.490</PartnerPrice>
                </PartnerPriceList>
            </Section>
