...
export function TicketsPage() {
    return (
        <>
            <VikingBanner header="The Ticket Booth" subHeader="Come join us in Oslo, in September, 2021"/>
            ...
            <Section color="green" header={<h1>What about the regular event?</h1>}>
                <p>Due to the COVID-19 outbreak we have decided to postpone the regular JavaZone 2020 until September 2021.</p>
